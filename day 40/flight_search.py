...
class FlightSearch:
    ...
    def _get_new_token(self):
        ...
        print(f"Your token is {result['access_token']}")
        print(f"Your token expires in {result['expires_in']} seconds")
    ...
    def get_destination_code(self, city_name):
        ...
        if response.status_code != 200:
            print(
                f"Failed to fetch IATA code for {city_name}. "
        ...
        if not locations:
            print(f"No airport results found for {city_name}.")
            return "N/A"

        # Prefer the first valid AIRPORT result
        ...
        print(f"No valid AIRPORT IATA code resolved for {city_name}.")
        return "N/A"
